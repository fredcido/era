...
<div class="forms_wrapper">
    <form action="<?php echo BASE; ?>/treinamento/participantes/saveeducacao/" method="post"  id="form-participantes-educacao"
...
<script type="text/javascript">
    ...
    $( '#form-participantes-educacao' ).populate( <?php echo $this->data; ?> );
