...
<div class="forms_wrapper">
    <form action="<?php echo BASE; ?>/treinamento/treinamento/saveendereco/" method="post"  id="form-treinamento-endereco"
			...
			<div class="inputs">
				...
				<li>
					...
					<select class="text required tip-error" name="fk_id_add_district" id="fk_id_add_district"
						onChange="carregaCombo( '/treinamento/treinamento/subdistritos/id/' + this.value, 'fk_id_add_subdistrict' );"
				...
				<li>
					...
					<select class="text required tip-error" name="fk_id_add_subdistrict" id="fk_id_add_subdistrict"
						onChange="carregaCombo( '/treinamento/treinamento/sukus/id/' + this.value, 'fk_id_add_suku' );"
...
<script type="text/javascript">
	...
	function()
	{
	    $( '#form-treinamento-endereco' ).populate( dataForm  );

	    if ( dataForm.fk_id_add_district ) {

		// Busca subdistritos e popula combo
		carregaCombo( 
		    '/treinamento/treinamento/subdistritos/id/' + dataForm.fk_id_add_district, 
		...
		carregaCombo( 
		    '/treinamento/treinamento/sukus/id/' + dataForm.fk_id_add_subdistrict, 
		    'fk_id_add_suku',
		    function()
		    {
