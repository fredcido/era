<script type="text/javascript" src="<?php echo BASE; ?>/public/scripts/relatorio/empresa.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo BASE; ?>/public/styles/relatorio/empresa.css" />
...
<div class="title_wrapper">
	...
	<div class="title_wrapper_content">
	    <h2><?php echo $this->t( 'Setores da empresa', 421 ); ?> </h2>	    
	</div>
    </div>
...
<div class="section_content report-container">
	...
	<div class="forms_wrapper">
	    <form action="<?php echo BASE; ?>/relatorio/empresa/relatoriosetor/" method="post"
			...
			<div class="row">
				...
				<ul>
					...
					<span class="input_wrapper">
					    <input class="text date-mask" name="dt_ini" id="dt_ini" type="text" />
					</span>
				    ...
				    <li>
					<span class="input_wrapper">
					    <input class="text date-mask" name="dt_fim" id="dt_fim" type="text" />
					</span>
