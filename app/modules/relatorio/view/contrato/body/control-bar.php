<div id="control-bar" class="noPrint">
    ...
    <a href="javascript:;" onClick="exporting( 'relatorio/me/topdf/', this );" class="button-pdf">
	<?php echo $this->t( 'Gerar PDF', 576 ); ?>
    </a>
    <a href="javascript:;" onClick="exporting( 'relatorio/me/todoc/', this );" class="button-doc">
	<?php echo $this->t( 'Gerar DOC', 577 ); ?>
    </a>
    <a href="javascript:;" onClick="exporting( 'relatorio/me/toexcel/', this );" class="button-excel">
