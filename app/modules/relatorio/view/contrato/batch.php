...
<div class="title_wrapper">
	...
	<div class="title_wrapper_content">
	    <h2><?php echo $this->t( 'Contract Batch', 688 ); ?></h2>	    
	</div>
    </div>
...
<div class="section_content report-container">
	...
	<div class="row row-button">
		...
		<input name="operacao" type="button" onclick="exportBatch();" />
	    </span>

	</div>
	<!--[if !IE]>end row<![endif]-->
	
	<div id="gridBatch" class="gridTela"></div>
	<div id="divPagBatches" class="pagingBlock"></div>
...
<script type="text/javascript">
	...
	function()
	{
	    initGridContratosBatch();
	    gridBatch.parse( <?php echo $this->dataBatches; ?>, 'json' );
	}
    )
</script>