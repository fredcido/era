<table>
	...
	<td>
	    <h1><?php echo $this->t( 'Participantes por grupo de idade', 369 ); ?> </h1>
	</td>
	<td style="width:1%">
...
<script type="text/javascript">
	...
	$( document ).ready(
		...
		chartPie = new Highcharts.Chart({
		    ...
		    title: {
			text: '<?php echo $this->t( 'Beneficiário por grupo de idade', 405 ); ?> (%)'
		    },
		    tooltip: {
		...
		chartBar = new Highcharts.Chart({
		    ...
		    xAxis: {
			categories: <?php echo json_encode( $this->data['graph_bar']['grupos'] ); ?>,
			title: {
			    text: null
			}
		    },
