...
<div class="title_wrapper">
	...
	<div class="title_wrapper_content">
	    <h2><?php echo $this->t( 'Participantes por distrito/sexo', 367 ); ?> </h2>	    
	</div>
    </div>
...
<div class="section_content report-container">
	...
	<div class="forms_wrapper">
	    <form action="<?php echo BASE; ?>/relatorio/treinamento/relatorioparticipantesdistritosexo/" method="post"
