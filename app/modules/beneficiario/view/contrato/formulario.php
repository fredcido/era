...
<link rel="stylesheet" type="text/css" href="<?php echo BASE; ?>/public/styles/beneficiario/contrato.css" />
...
<div class="title_wrapper">
    ...
    <div class="title_wrapper_inner">
        ...
        <div class="title_wrapper_content">
            ...
            <label> <?php echo $this->numContrato?> </label>
		...
		echo $this->_helper->aba()
			->addButton(
				array(
				    'class'	=> 'section_back',
				    'url'	=> BASE . '/beneficiario/contrato/',
				    'label'	=> 'Listar dados',
				    'trans_id'	=> 9,
