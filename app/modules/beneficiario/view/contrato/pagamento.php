...
<div class="forms_wrapper">
    <form action="<?php echo BASE; ?>/beneficiario/contrato/savepagamento/" method="post"  id="form-contrato-pagamento"
	  class="search_form general_form" onsubmit="return savePagamento( this );">
	<!--[if !IE]>start fieldset<![endif]-->
	<fieldset>

            <input name="id_contract" id="id_contract" value="<?php echo $this->data[0]['id_contract']; ?>" type="hidden" />
