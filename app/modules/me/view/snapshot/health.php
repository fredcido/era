...
<div class="forms_wrapper">
    <form action="<?php echo BASE; ?>/me/snapshot/saveindicator/" method="post" id="form-snapshot-health"
	...
	<fieldset>
		...
		<div class="abas-form">
		    ...
		    <!--[if !IE]>end row<![endif]-->
		    <iframe class="iframe-report" src="<?php echo BASE; ?>/me/snapshot/healthservice/id/<?php echo $this->snapshot; ?>"></iframe>
		</div>
