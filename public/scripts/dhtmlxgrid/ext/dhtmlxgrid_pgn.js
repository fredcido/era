...
dhtmlXGridObject.prototype.enablePaging = function(fl,pageSize,pagesInGrp,parentObj,showRecInfo,recInfoParentObj){
    ...
    if (!this.pagingBlock){
        ...
        if (!this._pgn_templateA){
            ...
            this._pgn_templateA=this._pgn_template_compile("[prevpages:" + imgprev + ":&nbsp;] [currentpages:,&nbsp;] [nextpages:" + imgnext + ":&nbsp;]");this._pgn_templateB=this._pgn_template_compile( t( 'Resultados', 208 ) + " <b>[from]-[to]</b> de <b>[total]</b>")
        }
